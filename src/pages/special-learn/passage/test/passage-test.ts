...
export class PassageTestPage {
  ...
  passageEn = "We, in turn, should also work hard in order to <span class='chunk'>guarantee the comfort and safety of generations to come</span>. <span class='chunk'>Sustainable development</span> has become a topic of heated debate in recent years. While <span class='chunk'>it is justifiable to</span> satisfy current demands, we cannot neglect the needs of our descendants in the process. Our children also depend on Earth's natural resources and we should not deprive them of such necessities. Unfortunately, many people only think of their short term, personal interests. An entire forest might be clear cut, in the interest of making a profit, without a single tree planted in its place. This inconsiderate attitude towards the welfare of our descendants, as well the indifference to the outcome of such reckless actions, can only turn Earth into a cold and lifeless planet."

  passageCn = "而我们，反过来，也要努力劳动来<span class='chunk'>确保我们后代的幸福和平安</span>。<span class='chunk'>可持续发展</span>是近几年的热点话题，虽然我们满足自己当前的需要<span class='chunk'>无可厚非</span>，但不能将子孙后代的需求抛置脑后。我们的孩子同样需要自然资源，我们不能剥夺他们的这份必需品。不幸的是很多人只考虑他们短视的、自私的利益。为了获得利润，整片的森林被砍光，一棵树都不留下。这种不顾及子孙福利的态度，和对这种轻率行为的后果的无动于衷，只会让我们的地球变成一个冷冰冰而无生气的行星。"
