...
@Component({
  selector: 'page-passage-learn1',
  templateUrl: 'passage-learn1.html'
})

export class PassageLearnPage1 {
  ...
  passageCn = "<p>The images above are <span class='chunk'>both meaningful and instructive</span>: this man's hard work is not only for his own benefit, but also for the benefit of future generations. <span class='chunk'>The pictures serve to remind us that</span> the existence of our current happiness and valuable national heritage is due to the struggles of our predecessors.</p><p>上面的漫画<span class='chunk-cn'>意味深长而发人深省</span>，栽树人的艰辛劳作不只是为了他自己，也是为了后人。<span class='chunk-cn'>这幅漫画是为了提醒我们</span>今天的幸福生活和宝贵的民族遗产归功于我们祖先的奋斗。</p><p>We, in turn, should also work hard in order to <span class='chunk'>guarantee the comfort and safety of generations to come</span>. <span class='chunk'>Sustainable development</span> has become a topic of heated debate in recent years. While <span class='chunk'>it is justifiable to</span> satisfy current demands, we cannot neglect the needs of our descendants in the process. Our children also depend on Earth's natural resources and we should not deprive them of such necessities. Unfortunately, many people only think of their short term, personal interests. An entire forest might be clear cut,<span class='chunk'>in the interest of making a profit</span>, without a single tree planted in its place. This inconsiderate attitude towards the welfare of our descendants, as well the indifference to the outcome of such reckless actions, can only turn Earth into a cold and lifeless planet.</p><p>而我们，反过来，也要努力劳动来<span class='chunk-cn'>确保我们后代的幸福和平安</span>。<span class='chunk-cn'>可持续发展</span>是近几年的热点话题，虽然我们满足自己当前的需要<span class='chunk'>无可厚非</span>，但不能将子孙后代的需求抛置脑后。我们的孩子同样需要自然资源，我们不能剥夺他们的这份必需品。不幸的是很多人只考虑他们短视的、自私的利益。<span class='chunk-cn'>为了获得利润</span>，整片的森林被砍光，一棵树都不留下。这种不顾及子孙福利的态度，和对这种轻率行为的后果的无动于衷，只会让我们的地球变成一个冷冰冰而无生气的行星。</p><p>People must be taught to appreciate Earth as not only their home, but also the home of our children and grandchildren, as well as all other plants and animals. While making great efforts to increase our current quality of life, we must simultaneously consider how our actions will affect future lives.</p><p>必须告诫人们的是：地球不仅是他们的家园，也是他们的孩子和所有后代的家园，还是其他所有的植物和动物的家园。在努力提高今天的生活质量的同时，我们必须考虑到我们的行为会对未来的生命产生什么样的影响。</p>"
