...
export class ExpressionTaskPage {
  ...
  status: string = 'init';
  tasks: object[] = [{en:'Industrial emissions',cn:'工业排放物'},{en:'slow down the rate of resource degradation',cn:'降低资源消耗率'},{en:'comply with',cn:'遵从'},{en:'clean up',cn:'清理'},{en:'harmful substances',cn:'有害物质'},{en:'lead a low-carbon life',cn:'过低碳的生活'},{en:'Behind them all, though, is the contradiction between economic growth and the environment.',cn:'所有这一切的背后是经济增长和环境保护之间的矛盾'},{en:'with the improvement of our living standard',cn:'随着我们的生活水平的提高'}];
